...
import com.zjy.mianshist.model.dto.questionBankQuestion.*;
...
public class QuestionBankQuestionController {
  ...
  @SaCheckRole(UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Boolean> removeQuestionBankQuestion(@RequestBody QuestionBankQuestionRemoveRequest questionBankQuestionRemoveRequest) {
        ...
        lambdaQueryWrapper.eq(QuestionBankQuestion::getQuestionBankId,questionBankQuestionRemoveRequest.getQuestionBankId()).eq(QuestionBankQuestion::getQuestionId,questionBankQuestionRemoveRequest.getQuestionId());
